...
const VideoTitle = ({ title, overview }) => {
  return (
    <div className='w-screen aspect-video pt-[20%] sm:pt-[18%] md:pt-[15%] px-4 sm:px-8 md:px-12 lg:px-24 absolute text-white bg-gradient-to-r from-slate-950 via-slate-900/80 to-transparent'>
      ...
      <div className='flex gap-2 sm:gap-3 lg:gap-3 mt-2 sm:mt-4 md:mt-6'>
        ...
        <button className='bg-slate-700/70 text-white px-3 sm:px-6 md:px-8 py-1 sm:py-2 md:py-3 text-xs sm:text-base md:text-lg font-bold rounded hover:bg-slate-600/70 hover:scale-105 flex items-center gap-1 sm:gap-2 transition-all duration-200'>
          <svg className="w-4 sm:w-5 md:w-6" fill="currentColor" viewBox="0 0 24 24">
